...
const DashboardHeader = () => {
  ...
  return (
    <div className="max-w-5xl flex flex-col md:flex-row md:items-center md:justify-between gap-6">
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="px-5 py-3 rounded-2xl bg-gradient-to-r from-[#EBC7D3] to-[#DCCBEF] text-[#2F2F2F] font-medium shadow-md hover:scale-[1.02] transition"
        >
          📊 View Analytics
        </button>
      </div>
