      ...
      <div className="relative z-10 w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="hidden md:flex flex-col justify-center pl-8">
          ...
          <h1 className="text-5xl font-semibold leading-tight text-[#2F2F2F]">
            Build your <span className="italic text-[#B88E9E]">routine</span>,
            <br />
            understand your <span className="italic text-[#8DA3B9]">energy</span>,
            and create <br />
            your calm system.
          </h1>

          <p className="mt-6 text-[#5F5F5F] text-lg max-w-lg leading-relaxed">
            Start your mindful productivity journey with a space designed
            to help you track habits, reflect deeply, and grow intentionally.
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <Card className="w-full max-w-md p-8 bg-white/70 backdrop-blur-xl shadow-[0_25px_70px_rgba(0,0,0,0.08)] border border-white/60">
            <div className="mb-8">
              <p className="text-sm text-[#8A8A8A] mb-2">Create your space 🌷</p>
              <h2 className="text-3xl font-semibold text-[#2F2F2F]">
                Start your journey
              </h2>
              <p className="text-[#6B6B6B] mt-2 text-sm">
                Build your calm productivity system from today.
              </p>
            </div>
            ...
            <div className="mt-6 text-sm text-[#6B6B6B] flex justify-end">
              <Link to="/login" className="hover:text-[#2F2F2F] font-medium transition">
